...
We would like to compare the charts described in the previous section in terms of probability 
reading, ie how well 
can the charts communicate the probability that the evolving target is within a certain interval 
at a certain time point. For this, we will inspire ourselves from the experiments of Brenner et al. 
...
for each hour of the day the probability distribution of the target variable. 
