...
After gathering all the answers from the participants, we grouped together the estimations per type of chart and built figure \ref{figure:errors} 
which shows 
the distribution of the reading error per type of chart, the confidence and the perceived difficulty. 

This distribution let us build a ranking of visualizations where the worst chart in terms of readability is the 
...
gradient charts are designed to showcase an general overview of the distribution as they represent the evolution of the
full range of percentiles, however the use of the "color" visual encoding limits the readability of the chart. On the other hand, natural 
