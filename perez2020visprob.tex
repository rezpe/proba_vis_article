...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{charts} 
...
For each answer, we calculate the error rate of each answer as the absolute value of the difference 
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{box_errors}
...
Confidence and cognitive load charts (figure \ref{figure:confi_load}) also prove the superior performance 
