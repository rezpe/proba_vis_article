...
Pang et al. were the first to gather uncertainty visualization techniques and classify them in order to bring order to the field and help practitioners choose the right visualization. However, their taxonomy did not explain how the visualization works nor helped creating new visualizations. Following uncertainty visualization surveys were based on data types (Potter et al. (2011) and Brodlie et al. (2012)), sources of uncertainty (Bonneau et al. (2014)), types of uncertainty (Ristovski et al. (2014))
