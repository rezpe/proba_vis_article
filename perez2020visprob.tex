...
Also, people already think in terms of uncertainty and they expect it in the forecasts: for example, for weather forecast 
...
points out, this could be also due to poor communication techniques. Weiskopf et al. reaches a similar conclusion and states 
...
This effort is based on data visualization. Indeed, as 
...
In this article, we will list all the researched ways to visualize and present uncertainty, 
