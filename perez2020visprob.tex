...
Our objective is to compare the readability of the four types of probabilistic time series charts 
described in the previous section and displayed in figure 1. 
The main question for this comparison is to understand how well each charts can be read 
when estimating the probability that the evolving target is within a certain interval at a certain time point. 
