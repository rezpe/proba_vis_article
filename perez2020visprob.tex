...
It is interesting to note that although we selected users with master level, we still did receive answers with probabilities 
...
Interestingly, we also recorded the time it takes to answer a question and built chart in figure \ref{figure:duration}. We 
