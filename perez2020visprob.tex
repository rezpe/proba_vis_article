...
In this article, we've gathered existing viz and come up with a new one. We compared them all using existing 
texhniques and we show the superiority of the new one. 
