...
is necessary to estimate risks and possible outcomes. For example, Rouston et al. 
\cite{roulston_laboratory_2006} showed that 
...
As Padilla et al. \cite{balakrishnan_uncertainty_2021} points out, this could be due not only to the abstract nature of probability 
...
field of uncertainty visualization 
...
the 10\% and 90\% percentile and finally a line’s edge shows the 1\% and 99\% percentile. 
