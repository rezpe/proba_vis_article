...
rewards that can be expected (Padilla et al., 2021 \citeext{padilla_uncertainty_2021}).
For example, Rouston et al. (2006) \citeextp{roulston_laboratory_2006} revealed how
...
quality forecasting, Perez-Vasseur et al. (2021) \citeextp{vasseur_comparing_2021} indicated 
how probabilistic
...
users. For example, Belia et al. (2005) \citeextp{belia_researchers_2005} showed that even
...
visualization. For instance, Perez Cota et al. (2014) \citeextp{cota_importance_2014}
...
et al. (2019) \citeextp{islam_overview_2019}, visualizations are easier for the human brain
...
As pointed out by Weiskopf et al. (2022) \citeextp{weiskopf_uncertainty_2022} or Padilla et
al. (2021) \citeextp{padilla_uncertainty_2021}, uncertainty visualization has motivated
...
Furthermore, as pointed out by Leffrang et al. (2021) \citeextp{leffrang_should_2021},
...
Brennen et al. (2018) \citeextp{brennen_instrument_2018}, we will propose a social
...
As noted by Joslyn et al. (2010) \citeextp{joslyn_communicating_2010}, the shortcomings in
uncertainty visualization lead to a new surge of research in visualization
techniques. Pang et al. (1997) \citeextp{pang_approaches_1997} were the first to gather
...
al., 2012 \citeext{potter_quantification_2012} and Brodlie et al., 2012)
\citeext{brodlie_review_2012}), sources of uncertainty (Bonneau et al., 2014
\citeext{bonneau_overview_2014}), types of uncertainty (Ristovski et al., 2014
\citeext{ristovski_uncertainty_2014}). Jena et al. (2020) \citeextp{jena_uncertainty_2020}
...
Belia et al. (2005) \citeextp{belia_researchers_2005} showed that even leading researchers
had trouble reading error bars as they confused standard errors and confidence
intervals. In addition, Joslyn and LeClerc \citeextp{joslyn_decisions_2013} (2013) showed
...
outcome plots) (Hullman et al., 2015) \citeext{hullman_hypothetical_2015}. 
...
noted by Gerd Gigerenzer (1996) \citeextp{gigerenzer_psychology_1996}, individuals prefer frequencies
...
Kay et al. (2016) \citeextp{2016-when-ish-is-my-bus}, represents the probability
...
al. (2016) \citeextp{2016-when-ish-is-my-bus} on the uncertainty of waiting times or
Brennen et al. (2018) \citeextp{brennen_instrument_2018}, who developed an approach to
evaluate uncertainty visualizations. Leffrang et al. (2021) \citeextp{leffrang_should_2021}
paper is the only example applied to time series forecasting uncertainty.

As noted by Cleveland et al. (1984) \citeextp{cleveland_graphical_1984} the basic
...
et al. (1984)\citeextp{cleveland_graphical_1984} produced a ranking of visual encodings
for numerical values with the position being the most accurate encoder. However,
as noted by Brennen et al. (2018) \citeextp{brennen_instrument_2018}, more complex
...
encodings (Cleveland et al., 1984) \citeext{cleveland_graphical_1984}.
...
experiments of Brennen et al. (2018) \citeextp{brennen_instrument_2018} and will use
...
set (as proposed by Brennen et al., 2018) \citeext{brennen_instrument_2018}, we select
...
python library (Van der Plas et al., 2018) \citeext{vanderplas2018altair} 
...
percentiles, however as shown by Cleveland et al. \citeextp{cleveland_graphical_1984}, the
...
the Kruskal-Wallis test (Kruskal et al., 1952 \citeext{krustal}) 
and the Quade test (Quade et al., 1967 \citeext{quade_rank_1967}). 
