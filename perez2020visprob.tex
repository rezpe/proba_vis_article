...
time series forecasting models are an example of this and they provide the full probability 
...
can be perceived as confusing. 

This worry prevents people from acessing decision making with uncertainty and it is superior to decision making without.  
People already think in terms of uncertainty 
and they expect it for forecasts: for weather forecast they
think in terms of ranges. Then using uncertainty can help you estimate the potential rewards and 
risks derived from your decision. For example Pinson mentioned how we can optimize the use of wind energy forecasts with 
uncertainty. Another example is the simulation where they gave uncertain estimations to participants and they were 
getting more revenues than the others.


Also, the uncertainty permits to correct the biases the people nmight have: 
Forecast like 
