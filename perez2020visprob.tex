...
As noted by Pang et al. \cite{pang_approaches_1997}, the basic methodology to compare visualizations is to measure how accurate is the 
...
the gradient chart, the box plot or the confidence interval charts. Also, we came up with a 
novel way to visualize uncertainty based on natural frequencies.
As the probabilities are used to estimate risks and rewards from decisions, we wanted to compare them against a predefined set of 
metrics around the user's probability reading ability.
