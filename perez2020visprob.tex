...
It is interesting to note that although we selected users with master level, we still did received answers with probabilities 
...
We can perform a statistical comparison of the reading errors with the ... test. This test shows the following ranking and confirms 
our conclusions from the visual inspection of the chart.
