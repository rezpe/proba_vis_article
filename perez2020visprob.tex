...
\begin{figure}
  \centering
  \multicolumn{2}[c}{\includegraphics[width=0.6\textwidth]{gradient} \includegraphics[width=0.6\textwidth]{boxplot}}
  \multicolumn{2}[c}{\includegraphics[width=0.6\textwidth]{ci} \includegraphics[width=0.6\textwidth]{dot}}
...
\begin{figure}
  \centering
   \includegraphics[width=0.6\textwidth]{gradient}
...
\begin{figure}
  \centering
   \multicolumn{2}[c}{\includegraphics[width=0.6\textwidth]{confidence} \includegraphics[width=0.6\textwidth]{load}}
